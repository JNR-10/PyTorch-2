"""
Training of DCGAN network on MNIST dataset with 
Discriminator and Generator defined in model.py
"""
...
# Hyperparameters etc.
# DCGAN is incredibly sensitive to hyperparameters, so these values are important
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
lr = 2e-4 # learning rate for Adam as per DCGAN paper
batch_size = 128
image_size = 64
...
for epoch in range(num_epochs): # 5 epochs is good enough for MNIST
